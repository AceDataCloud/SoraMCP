...
//
// Registers the hosted Ace Data Cloud "sora" MCP server with VS Code
...
//   2. VS Code SecretStorage (key "sora.apiToken")
...
//   - acedatacloud.sora.setApiToken
//   - acedatacloud.sora.clearApiToken

const vscode = require("vscode");

const PROVIDER_ID = "acedatacloud.sora";
const SERVER_LABEL = "Sora MCP";
const SERVER_URL = "https://sora.mcp.acedata.cloud/mcp";
const SET_TOKEN_CMD = "acedatacloud.sora.setApiToken";
const CLEAR_TOKEN_CMD = "acedatacloud.sora.clearApiToken";
// Per-extension SecretStorage namespace; we keep one key per service so
// rotating one API key doesn't affect siblings.
const SECRET_KEY = "sora.apiToken";
